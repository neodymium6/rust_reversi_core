...
fn get_alpha_beta4_piece() -> AlphaBetaSearch {
    AlphaBetaSearch::new(4, Arc::new(PieceEvaluator::new()), 1 << 10)
}

fn get_alpha_beta4_legal_num() -> AlphaBetaSearch {
    AlphaBetaSearch::new(4, Arc::new(LegalNumEvaluator::new()), 1 << 10)
}
...
fn get_alpha_beta4_matrix() -> AlphaBetaSearch {
    ...
    AlphaBetaSearch::new(4, Arc::new(evaluator), 1 << 10)
}
...
fn get_alpha_beta4_custom() -> AlphaBetaSearch {
    AlphaBetaSearch::new(4, Arc::new(CustomEvaluator {}), 1 << 10)
}
